...
func NewBackRepo(stage *models.StageStruct, filename string) (backRepo *BackRepoStruct) {
	...
	// insertion point for per struct back repo declarations
	backRepo.BackRepoLadybug = BackRepoLadybugStruct{
		Map_LadybugDBID_LadybugPtr: make(map[uint]*models.Ladybug, 0),
		Map_LadybugDBID_LadybugDB:  make(map[uint]*LadybugDB, 0),
		Map_LadybugPtr_LadybugDBID: make(map[*models.Ladybug]uint, 0),

		db:    db,
		stage: stage,
	}
	backRepo.BackRepoLadybugSimulation = BackRepoLadybugSimulationStruct{
		Map_LadybugSimulationDBID_LadybugSimulationPtr: make(map[uint]*models.LadybugSimulation, 0),
		Map_LadybugSimulationDBID_LadybugSimulationDB:  make(map[uint]*LadybugSimulationDB, 0),
		Map_LadybugSimulationPtr_LadybugSimulationDBID: make(map[*models.LadybugSimulation]uint, 0),
...
func (backRepo *BackRepoStruct) Commit(stage *models.StageStruct) {
	...
	backRepo.BackRepoLadybug.ResetReversePointers(backRepo)
	backRepo.BackRepoLadybugSimulation.ResetReversePointers(backRepo)
