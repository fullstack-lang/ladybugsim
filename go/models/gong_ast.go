...
var __gong__map_Ladybug = make(map[string]*Ladybug)
var __gong__map_LadybugSimulation = make(map[string]*LadybugSimulation)
						...
						case *ast.CompositeLit:
							...
							case *ast.SelectorExpr:
								...
								if Sel := slcExpr.Sel; Sel != nil {
									...
									case "Ladybug":
										instanceLadybug := (&Ladybug{Name: instanceName}).Stage(stage)
										instance = any(instanceLadybug)
										__gong__map_Ladybug[identifier] = instanceLadybug
									case "LadybugSimulation":
										instanceLadybugSimulation := (&LadybugSimulation{Name: instanceName}).Stage(stage)
										instance = any(instanceLadybugSimulation)
										__gong__map_LadybugSimulation[identifier] = instanceLadybugSimulation
									}
				...
				case *ast.Ident:
					...
					case "LadybugSimulation":
						...
						case "Ladybugs":
							...
							target := __gong__map_Ladybug[targetIdentifier]
							__gong__map_LadybugSimulation[identifier].Ladybugs =
								append(__gong__map_LadybugSimulation[identifier].Ladybugs, target)
						}
					}
				case *ast.SelectorExpr:
					slcExpr := arg
		...
		case *ast.BasicLit, *ast.UnaryExpr:
			...
			case "Ladybug":
				...
				case "Name":
					...
					__gong__map_Ladybug[identifier].Name = fielValue
				case "Id":
					...
					__gong__map_Ladybug[identifier].Id = int(exprSign) * int(fielValue)
				case "Position":
					...
					__gong__map_Ladybug[identifier].Position = exprSign * fielValue
				case "Speed":
					// convert string to float64
					fielValue, err := strconv.ParseFloat(basicLit.Value, 64)
					if err != nil {
					...
					__gong__map_Ladybug[identifier].Speed = exprSign * fielValue
				}
			case "LadybugSimulation":
				switch fieldName {
				// insertion point for field dependant code
				case "Name":
					// remove first and last char
					fielValue := basicLit.Value[1 : len(basicLit.Value)-1]
					__gong__map_LadybugSimulation[identifier].Name = fielValue
				case "EventNb":
					// convert string to int
					fielValue, err := strconv.ParseInt(basicLit.Value, 10, 64)
					if err != nil {
					...
					__gong__map_LadybugSimulation[identifier].EventNb = int(exprSign) * int(fielValue)
				case "NbOfCollision":
					// convert string to int
					fielValue, err := strconv.ParseInt(basicLit.Value, 10, 64)
					if err != nil {
					...
					__gong__map_LadybugSimulation[identifier].NbOfCollision = int(exprSign) * int(fielValue)
				case "LadybugRadius":
					// convert string to float64
					fielValue, err := strconv.ParseFloat(basicLit.Value, 64)
					if err != nil {
					...
					__gong__map_LadybugSimulation[identifier].LadybugRadius = exprSign * fielValue
				case "AbsoluteSpeed":
					// convert string to float64
					fielValue, err := strconv.ParseFloat(basicLit.Value, 64)
					if err != nil {
					...
					__gong__map_LadybugSimulation[identifier].AbsoluteSpeed = exprSign * fielValue
				case "SimulationStep":
					...
					__gong__map_LadybugSimulation[identifier].SimulationStep = time.Duration(fielValue)
				case "MaxDistanceInOneStep":
					...
					__gong__map_LadybugSimulation[identifier].MaxDistanceInOneStep = exprSign * fielValue
				case "NbLadybugs":
					// convert string to int
					fielValue, err := strconv.ParseInt(basicLit.Value, 10, 64)
					if err != nil {
					...
					__gong__map_LadybugSimulation[identifier].NbLadybugs = int(exprSign) * int(fielValue)
				case "NbLadybugsOnTheGround":
					...
					__gong__map_LadybugSimulation[identifier].NbLadybugsOnTheGround = int(exprSign) * int(fielValue)
				case "LeftRelayInitialPosX":
					...
					__gong__map_LadybugSimulation[identifier].LeftRelayInitialPosX = exprSign * fielValue
				case "RightRelayInitialPosX":
					...
					__gong__map_LadybugSimulation[identifier].RightRelayInitialPosX = exprSign * fielValue
				}
			}
		case *ast.Ident:
		...
		case *ast.SelectorExpr:
			...
			if Sel := selectorExpr.Sel; Sel != nil {
				...
				case "Ladybug":
					...
					case "LadybugStatus":
						var val LadybugStatus
						err := (&val).FromCodeString(enumValue)
						if err != nil {
							log.Fatalln(err)
						}
						__gong__map_Ladybug[identifier].LadybugStatus = LadybugStatus(val)
					}
				case "LadybugSimulation":
					switch fieldName {
					// insertion point for enum assign code
