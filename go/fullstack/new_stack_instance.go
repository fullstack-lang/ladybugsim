...
import (
	...
	_ "github.com/fullstack-lang/ladybugsim/ng/projects"
)
...
func NewStackInstance(
	...
	// add orchestration
	// insertion point
	models.SetOrchestratorOnAfterUpdate[models.Ladybug](stage)
	models.SetOrchestratorOnAfterUpdate[models.LadybugSimulation](stage)
