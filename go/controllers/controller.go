...
type Controller struct {
	...
	Map_BackRepos map[string]*ladybugsim_orm.BackRepoStruct
}
...
func GetController() *Controller {
	doControllerInitOnce.Do(func() {
		_controllerSingloton = &Controller{
			Map_BackRepos: make(map[string]*ladybugsim_orm.BackRepoStruct),
		}
	})
	return _controllerSingloton
}

func (controller *Controller) AddBackRepo(backRepo *ladybugsim_orm.BackRepoStruct, stackPath string) {
