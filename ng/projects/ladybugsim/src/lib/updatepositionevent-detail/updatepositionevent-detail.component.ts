...
enum UpdatePositionEventDetailComponentState {
	CREATE_INSTANCE,
	UPDATE_INSTANCE,
...
@Component({
	selector: 'app-updatepositionevent-detail',
	templateUrl: './updatepositionevent-detail.component.html',
	styleUrls: ['./updatepositionevent-detail.component.css'],
})
export class UpdatePositionEventDetailComponent implements OnInit {
	...
	ngOnInit(): void {
		...
		if (this.id == 0) {
			this.state = UpdatePositionEventDetailComponentState.CREATE_INSTANCE
		} else {
			if (this.originStruct == undefined) {
				this.state = UpdatePositionEventDetailComponentState.UPDATE_INSTANCE
			} else {
	...
	getUpdatePositionEvent(): void {
		...
		this.frontRepoService.pull().subscribe(
			frontRepo => {
				...
				switch (this.state) {
					case UpdatePositionEventDetailComponentState.CREATE_INSTANCE:
	...
	save(): void {
		...
		this.updatepositionevent.Duration =
		...
		switch (this.state) {
			case UpdatePositionEventDetailComponentState.UPDATE_INSTANCE:
				this.updatepositioneventService.updateUpdatePositionEvent(this.updatepositionevent)
	...
	openReverseSelection(AssociatedStruct: string, reverseField: string, selectionMode: string,
		...
		if (selectionMode == SelectionMode.MANY_MANY_ASSOCIATION_MODE) {
			...
			// set up the source
			dialogData.SourceStruct = "UpdatePositionEvent"
	...
	openDragAndDropOrdering(AssociatedStruct: string, reverseField: string) {
		...
		dialogConfig.autoFocus = true;
		dialogConfig.data = {
			ID: this.updatepositionevent.ID,
